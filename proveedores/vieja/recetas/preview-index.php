...
$sql="SELECT * FROM Recetarios, CRISTALES where Id_Cliente =".$_GET["Id_Cliente"]." AND CRISTALES.Id_Receta = Recetarios.Id_Receta ";
//print_r($_GET);
...
<td valign="top" align="Cristal" width="300">
<?php
echo chao_tilde($reg["Tipo_cristal"]);
?>
</td>
