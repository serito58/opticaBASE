...
<?php
$sql="select * from clientes order by id_cliente desc LIMIT 10";
...
<td valign="top" align="center" width="25">
<a href="../clientes/recetas/index.php?id_cliente=<?php echo $reg["id_cliente"];?>" target=recetas title="Recetas"><img src="ima/folder.png" border="0"></a>
</td>
</tr>
<?php
}
